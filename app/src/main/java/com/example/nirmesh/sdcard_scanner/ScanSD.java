...
public class ScanSD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fileList = new ArrayList<> (FileUtils.listFiles(file, new RegexFileFilter("^(.*?)"), DirectoryFileFilter.DIRECTORY));
    ...
    private static Collection<String> getFrequentlyUsedExtn(Collection<File> files){
        ...
        return new ArrayList<>(sortedMap.keySet()).subList(0, ((sortedMap.keySet().size() <5) ? sortedMap.keySet().size() : 5));
    }
